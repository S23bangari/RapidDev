...
export default {
  ...
  SIGNIN_HEADING: 'Continue With Rapid Dev',
  SIGNIN_SUBHEADING: 'To use Rapid Dev you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Rapid Dev, you agree to the collection of usage data for analytics.',
